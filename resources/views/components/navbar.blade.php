<header x-data="{ mobileMenu: false, searchOpen: false }" class="relative z-50">
    <div class="bg-[#0e4d3d]">
        <div class="max-w-screen-xl mx-auto px-4 flex items-center justify-between gap-2 py-1.5">
            ...
            <div class="flex items-center gap-1.5 flex-wrap">
                ...
                <a href="#"
                    ...
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 0 0 1 18 0z" />
            ...
            <div class="flex items-center gap-1 text-white text-xs font-medium shrink-0">
                <a href="#" class="hover:underline opacity-90">Đăng ký</a>
                <span class="opacity-40 mx-1">|</span>
                <a href="#" class="hover:underline opacity-90">Đăng nhập</a>
            </div>
    ...
    <div class="bg-white shadow-sm sticky top-0">
        <div class="max-w-screen-xl mx-auto px-4 py-3 flex items-start justify-between gap-4 lg:gap-8">
            ...
            <a href="#" class="flex items-center gap-2 shrink-0 pt-0.5">
            ...
            <div class="flex items-center gap-2 lg:gap-3 shrink-0 pt-[2px]">
                ...
                <a href="tel:0986552233"
                    class="hidden xl:flex items-center gap-2.5 px-3 py-1.5 border border-slate-200 rounded-xl hover:border-[#0e4d3d] hover:bg-green-50 transition group transition-all duration-300">
                ...
                <a href="#"
                    class="hidden md:flex items-center gap-2.5 px-3 py-1.5 border border-slate-200 rounded-xl hover:border-[#0e4d3d] hover:bg-green-50 transition group transition-all duration-300">
                ...
                <a href="#"
                    class="flex items-center gap-2 px-3 py-1.5 border border-slate-200 rounded-xl hover:border-[#0e4d3d] hover:bg-green-50 transition group relative transition-all duration-300">
                    <div class="relative">
    ...
    <div class="bg-white border-t border-b border-slate-100 shadow-sm">
