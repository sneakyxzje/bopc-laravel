    ...
    <div class=" w-full space-y-8">
        <div class="bg-white p-8 rounded-3xl shadow-xl shadow-zinc-200/60 border border-[#f2f2f2]">
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                @endif
                <div class="space-y-2">
                    <label for="email" class="text-xs font-bold text-near-black uppercase px-1">Địa chỉ Email</label>
                ...
                <div class="space-y-2" x-data="{ show: false }">
                    <div class="flex items-center justify-between px-1">
                        <label for="password" class="text-xs font-bold text-near-black uppercase">Mật khẩu</label>
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray group-focus-within:text-[#0e4d3d] transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-secondary-gray/50 hover:text-[#0e4d3d] transition-colors">
                ...
                <div class="flex items-center">
                    <input id="remember-me" name="remember" type="checkbox"
                        class="h-4 w-4 text-[#0e4d3d] focus:ring-[#0e4d3d] border-[#ebebeb] rounded-lg cursor-pointer transition-all">
                    <label for="remember-me" class="ml-2 block text-sm text-secondary-gray font-medium cursor-pointer">
                        Ghi nhớ đăng nhập
                    </label>
                </div>
