...
<div class="min-h-[70vh] flex items-center justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="max-w-md w-full space-y-8">
        <div class="bg-white p-8 rounded-3xl shadow-xl shadow-zinc-200/60 border border-[#f2f2f2]">
            <form class="space-y-6" action="{{ route('register') }}" method="POST"
                ...
                <div class="space-y-2">
                    <label for="name" class="text-xs font-bold text-near-black uppercase px-1">Họ và tên</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray/50 group-focus-within:text-[#0e4d3d] transition-colors">
                        ...
                        <input id="name" name="name" type="text" x-model="name" x-on:input.debounce.300ms="validateName()" required autofocus autocomplete="name"
                            class="block w-full pl-11 pr-4 py-3 border-2 border-[#f2f2f2] bg-[#f7f7f7]/50 rounded-2xl text-near-black placeholder-secondary-gray focus:outline-none focus:border-[#0e4d3d]/50 focus:bg-white transition-all text-sm sm:text-base @error('name') border-red-500 @enderror"
                ...
                <div class="space-y-2">
                    <label for="phone" class="text-xs font-bold text-near-black uppercase px-1">Số điện thoại</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray/50 group-focus-within:text-[#0e4d3d] transition-colors">
                        ...
                        <input id="phone" name="phone" type="text" x-model="phone" x-on:input.debounce.300ms="validatePhone()"
                            class="block w-full pl-11 pr-4 py-3 border-2 border-[#f2f2f2] bg-[#f7f7f7]/50 rounded-2xl text-near-black placeholder-secondary-gray focus:outline-none focus:border-[#0e4d3d]/50 focus:bg-white transition-all text-sm sm:text-base @error('phone') border-red-500 @enderror"
                ...
                <div class="space-y-2">
                    <label for="address" class="text-xs font-bold text-near-black uppercase px-1">Địa chỉ</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray/50 group-focus-within:text-[#0e4d3d] transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <input id="address" name="address" type="text" x-model="address"
                            class="block w-full pl-11 pr-4 py-3 border-2 border-[#f2f2f2] bg-[#f7f7f7]/50 rounded-2xl text-near-black placeholder-secondary-gray focus:outline-none focus:border-[#0e4d3d]/50 focus:bg-white transition-all text-sm sm:text-base @error('address') border-red-500 @enderror"
                ...
                <div class="space-y-2">
                    <label for="email" class="text-xs font-bold text-near-black uppercase px-1">Email</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray/50 group-focus-within:text-[#0e4d3d] transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <input id="email" name="email" type="email" x-model="email" x-on:input.debounce.300ms="validateEmail()" required autocomplete="email"
                            class="block w-full pl-11 pr-4 py-3 border-2 border-[#f2f2f2] bg-[#f7f7f7]/50 rounded-2xl text-near-black placeholder-secondary-gray focus:outline-none focus:border-[#0e4d3d]/50 focus:bg-white transition-all text-sm sm:text-base @error('email') border-red-500 @enderror"
                ...
                <div class="space-y-2">
                    <label for="password" class="text-xs font-bold text-near-black uppercase px-1">Mật khẩu</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray/50 group-focus-within:text-[#0e4d3d] transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <input id="password" name="password" type="password" x-model="password" x-on:input.debounce.300ms="validatePassword()" :type="showPassword ? 'text' : 'password'" required autocomplete="new-password"
                            class="block w-full pl-11 pr-12 py-3 border-2 border-[#f2f2f2] bg-[#f7f7f7]/50 rounded-2xl text-near-black placeholder-secondary-gray focus:outline-none focus:border-[#0e4d3d]/50 focus:bg-white transition-all text-sm sm:text-base @error('password') border-red-500 @enderror"
                            placeholder="••••••••">
                        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-secondary-gray/50 hover:text-[#0e4d3d] transition-colors">
                ...
                <div class="space-y-2">
                    <label for="password_confirmation" class="text-xs font-bold text-near-black uppercase px-1">Nhập lại mật khẩu</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-secondary-gray/50 group-focus-within:text-[#0e4d3d] transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password" x-model="password_confirmation" x-on:input.debounce.300ms="validateConfirmation()" :type="showConfirmPassword ? 'text' : 'password'" required autocomplete="new-password"
                            class="block w-full pl-11 pr-12 py-3 border-2 border-[#f2f2f2] bg-[#f7f7f7]/50 rounded-2xl text-near-black placeholder-secondary-gray focus:outline-none focus:border-[#0e4d3d]/50 focus:bg-white transition-all text-sm sm:text-base"
                            placeholder="••••••••">
                        <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-secondary-gray/50 hover:text-[#0e4d3d] transition-colors">
                ...
                <div>
                    <button type="submit"
                        class="group relative cursor-pointer w-full flex justify-center py-3.5 px-4 border border-transparent text-sm font-black rounded-2xl text-white bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all transform hover:-translate-y-0.5 active:translate-y-0 shadow-lg shadow-red-900/20 uppercase">
                        Đăng ký ngay
                    </button>
                </div>
            </form>
            ...
            <div class="mt-8 relative">
                ...
                <div class="relative flex justify-center text-xs uppercase">
                    <span class="px-3 bg-white text-secondary-gray/50 font-bold">Hoặc</span>
                </div>
            </div>

            <div class="mt-8 text-center">
                <p class="text-sm text-secondary-gray font-medium">
                    Đã có tài khoản?
